...
public class PushApplication extends Application {
    ...
    private void enablePush() {
        ...
        UmengNotificationClickHandler notificationClickHandler = new UmengNotificationClickHandler() {
            ...
            public void launchApp(Context context, UMessage msg) {
                Log.i("MipushActivity", msg.toString()+"====1");
            ...
            public void openUrl(Context context, UMessage msg) {
                ...
                Log.i("MipushActivity", msg.toString()+"====2");
                clikHandlerSendEvent(PushModule.DidOpenMessage, msg);
            }
            ...
            public void openActivity(Context context, UMessage msg) {
                ...
                Log.i("MipushActivity", msg.toString()+"====3");
                clikHandlerSendEvent(PushModule.DidOpenMessage, msg);
            }
            ...
            public void dealWithCustomAction(Context context, UMessage msg) {
                ...
                Log.i("MipushActivity", msg.toString()+"====4");
                clikHandlerSendEvent(PushModule.DidOpenMessage, msg);
            }
        };
        ...
        mPushAgent.setMessageHandler(new UmengMessageHandler() {
            ...
            public Notification getNotification(Context context, UMessage msg) {
                ...
                Log.i(TAG, "推送消息监听");
                Log.i("MipushActivity", msg.toString()+"====5");
            ...
            public void dealWithCustomMessage(Context context, UMessage msg) {
                ...
                Log.i("MipushActivity", msg.toString()+"====6");
                messageHandlerSendEvent(PushModule.DidReceiveMessage, msg);
            }
        });
    }
    ...
    private void clikHandlerSendEvent(final String event, final UMessage msg) {
        ...
        Log.i("MipushActivity", msg.toString()+"====8");
        //延时500毫秒发送推送，否则可能收不到
        new Handler().postDelayed(new Runnable() {
            public void run() {
                Log.i("MipushActivity", msg.toString()+"====9");
    ...
    private void messageHandlerSendEvent(String event, UMessage msg) {
        ...
        Log.i("MipushActivity", msg.getRaw().toString()+"====7");
        mPushModule.sendEvent(event, msg);
    }
